...
# 平台基础URL
declare -A PLATFORMS=(
  ["x86_64"]="https://downloads.immortalwrt.org/releases/24.10.4/packages/x86_64"
  ["aarch64_generic"]="https://downloads.immortalwrt.org/releases/24.10.4/packages/aarch64_generic"
  ["aarch64_cortex-a53"]="https://downloads.immortalwrt.org/releases/24.10.4/packages/aarch64_cortex-a53"
)

# 各类包对应的目录
declare -A PACKAGE_SOURCES=(
  ["luci-app-daed"]="luci"
  ["luci-i18n-daed-zh-cn"]="luci"
  ["daed_"]="packages"
  ["daed-geoip"]="packages"
  ["daed-geosite"]="packages"
)
